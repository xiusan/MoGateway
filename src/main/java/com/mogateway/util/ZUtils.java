...
public class ZUtils {
    ...
    public static void z7z(String input, String filename, String output) throws Exception {
        try {
            SevenZOutputFile sevenZOutputFile = null;

            sevenZOutputFile = new SevenZOutputFile(new File(output));
     ...
     */
    public static String archive(String entry) throws Exception {

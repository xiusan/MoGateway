...
public class UnzipJob implements BaseJob {
  
    private static Logger log = LoggerFactory.getLogger(UnzipJob.class);
    ...
    public void execute(JobExecutionContext context)
        ...
        try {
           redisService.setValue(Constants.EXECUT_COUNT+jobName, JsonUtils.objectToJson(count));
            ...
            String info = HttpClientUtil.httpGet("http://192.168.1.123:8181/Diagnosis/cronRemote/cronFaultFile", null, null);

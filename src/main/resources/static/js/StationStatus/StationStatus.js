...
var bootstrapTableOption = {
    ...
    columns: [
        ...
        {title: '序号', align: 'center', formatter: 'increases'},
            { field: 'stationStatus', title: '站点状态ID'},
            { field: 'stationStatusName', title: '站点状态名称'},
...
$(document).ready(function() {
    ...
    setBootstrapTable('#operatorStationStatus', bootstrapTableOption);  //初始化页面table
});

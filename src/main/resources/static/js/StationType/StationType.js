...
var bootstrapTableOption = {
    ...
    columns: [
        ...
        {title: '序号', align: 'center', formatter: 'increases'},
            { field: 'id', title: 'id'},
            { field: 'stationType', title: '站点类型ID'},
            { field: 'stationTypeName', title: '站点类型名称'},
...
$(document).ready(function() {
    ...
    setBootstrapTable('#operatorStationType', bootstrapTableOption);  //初始化页面table
});

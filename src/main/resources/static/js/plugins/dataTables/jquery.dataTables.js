...
(/** @lends <global> */function( $ ) {
	 ...
	 *    are defined by {@connect DataTable.defaults}
	 *  @requires jQuery 1.3+
	 *
	 *  @example
	...
	DataTable = function( options )
	{
		 ...
		 *    <i>aoData</i> ({@connect DataTable.models.oSettings}) that have been added to
		 *    the table.
		 *  @dtopt API
		 *  @deprecated Since v1.10
		 *
		 ...
		 *    {@connect DataTable.models.oSettings}
		 *  @dtopt API
		 *  @deprecated Since v1.10
		 *
		 *  @example
	 ...
	 *
	 * Note that this object is related to {@connect DataTable.defaults.column}
	...
	DataTable.defaults = {
		 ...
		 *
		 * @example
		 *   // Manipulate the data returned from the server - add a connect to data
	 ...
	 * instance.
	 *
	 * Note that this object is related to {@connect DataTable.defaults} but this
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			 ...
			 * set a default use {@connect DataTable.defaults}.
			 *  @type boolean
			 */
			"bAutoWidth": null,
		...
		"oLanguage": {
			 ...
			 * {@connect DataTable.defaults.fnInfoCallback}
			 *  @type function
			 *  @default null
			 */
			"fnInfoCallback": null
		...
		/**
		 * Store data information - see {@connect DataTable.models.oRow} for detailed
		 * information.
		 *  @type array
		 *  @default []
		 */
		 ...
		 * {@connect DataTable.models.oSearch} for the format that is used for the
		 ...
		 * {@connect DataTable.model.oInit.sDom}.
		 * Note that this parameter will be set by the initialisation routine. To
		 * set a default use {@connect DataTable.defaults}.
		 *  @type string
		 *  @default null
	...
	DataTable.ext = _ext = {
		 ...
		 * 3. `{int}` Row index ({@connect DataTable.models.oSettings.aoData}), which
		 ...
		 * {@connect DataTable.ext.renderer.pageButton}. The renderer addresses how the

...
public String getShengdaojiaList(Shengdaojia shengdaojia){
	...
	StringBuffer sql = new StringBuffer();
		...
		sql.append("  FROM SHENGDAOJIA  ");//表名
	return sql.toString();
...
public String saveShengdaojia(Shengdaojia shengdaojia){
			...
			StringBuffer sql = new StringBuffer();
			sql.append("insert into SHENGDAOJIA");
			sql.append("(" );
			sql.append("NUM_ID,");
			sql.append("TITLE,");
			sql.append("PICT_URL,");
...
public String updateShengdaojia(Shengdaojia shengdaojia){
			...
			StringBuffer sql = new StringBuffer();
			sql.append("update SHENGDAOJIA set ");
...
public String delShengdaojia(Shengdaojia shengdaojia) {
				String newSql = "  SHENGDAOJIA  where   NUM_ID in (";
			String[] split =  shengdaojia.getId().split(",");
